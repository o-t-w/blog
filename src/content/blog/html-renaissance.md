...
While, as the consumer of this code, you don't need to read or maintain it, it does speak to the complexity of modern frontend. Here's a brief truncated snippet from just one of those files:
